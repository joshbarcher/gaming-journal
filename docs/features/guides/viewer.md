...
| `src/lib/svelte/journal/guide/GuideBlockRenderer.svelte` | Renders ContentBlock[] to DOM (paragraphs, headings, tables, images, videos) |
| `src/lib/svelte/journal/guide/GuideVideo.svelte` | Video block → poster-frame card opening the Tributary modal. See [videos.md](videos.md) |
